...
class CharRNN:
    ...
    def __init__(self, num_classes,
        ...
        self.inputs, self.targets, self.keep_prob = build_inputs(batch_size,
                                                                 num_steps)
        ...
        for e in range(epochs):
            ...
            for x, y in get_batches(encoded, batch_size, num_steps):
                ...
                if counter % save_every_n == 0:
                    ...
                    saver.save(sess, "./anna/i{}_l{}.ckpt".format(counter,
                                                                  lstm_size))
...
if mode == "gen":
    ...
    samp = sample(checkpoint, sample_text_size,
                  lstm_size, len(vocab), prime="The")
    print(samp, "\n")
